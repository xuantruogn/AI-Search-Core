...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  try {
    if (!searchLanguage || Intl.getCanonicalLocales(searchLanguage).length !== 1) throw new Error();
  } catch {
        ...
        <fetcher.Form method="post">
          ...
          <div style={{ display: "grid", gap: 16, maxWidth: 620 }}>
            <label>
              ...
              <input name="searchLanguage" list="search-languages" required
                defaultValue={data.searchLanguage ?? ""} placeholder="vi, en, zh-Hans…"
            ...
            <s-text>Sau khi đổi ngôn ngữ, vào Catalog &amp; Vector Index và quét lại toàn bộ catalog để đồng bộ sản phẩm.</s-text>
